...
export interface Registry {
  ...
  'transaction.store': {
    ...
    types: {
      body: ExtractBody<InferInput<(typeof import('#validators/transaction').checkoutValidator)>>
      paramsTuple: []
      params: {}
      query: ExtractQuery<InferInput<(typeof import('#validators/transaction').checkoutValidator)>>
